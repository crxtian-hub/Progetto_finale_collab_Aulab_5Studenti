<div> 
    <form class="container w-50 form_article text-blue fw-bold" wire:submit="articleUpdate">
        @csrf
        <div class="mb-3">
            <label for="title" class="form-label">{{__('ui.Article')}}</label>
        ...
        <div class="mb-3">
            <label for="price" class="form-label">{{__('ui.Categories')}}</label>
        ...
        <div class="d-flex justify-content-center align-items-center flex-column">
            <p class= "h5">{{__('ui.Uploaded Photos')}}</p>
            
            <img src="{{$article->images->isNotEmpty() ? $article->images->first()->getUrl(300, 300) : 'https://picsum.photos/200'}}" alt="Immagine di {{$article->title}}">
            
        </div>
        <div class="btn-container d-flex justify-content-center align-items-center flex-column">
            
            
            <button class="createButton m-2">{{__('ui.Modify')}}</button>
            ...
            <a href="#" class="btn DeleteButton" data-bs-toggle="modal" data-bs-target="#exampleModal">
                Elimina
            </a>
            <!-- Modal -->
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Sicuro di voler eliminarlo?</h5>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger" wire:click.prevent="destroy">Elimina</button>
                        </div>
                    </div>
                </div>
            </div>
